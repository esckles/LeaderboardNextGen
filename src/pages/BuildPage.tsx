...
import ex from "../assets/abstract-background-design-images-wallpaper-ai-generated_643360-256061.jpeg";
...
const BuildPage = () => {
  ...
  return (
    <div className="font-semibold font-sans text-white">
      ...
      >
        <div className="w-[80%] h-[100vh] flex flex-col items-center justify-center">
